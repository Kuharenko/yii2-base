...
class Module extends \yii\base\Module
{
    ...
    protected function checkModuleProperties()
    {
        ...
        if ($userComponent && !$userComponent instanceof \backend\modules\user\components\User) {
            throw new InvalidConfigException('Yii::$app->user is not set properly. It needs to extend \backend\modules\user\components\User');
        }
    }
    ...
    protected function getDefaultModelClasses()
    {
        ...
        return [
            ...
            'UserToken' => 'backend\modules\user\models\UserToken',
            ...
            'UserSearch' => 'backend\modules\user\models\search\UserSearch',
            'LoginEmailForm' => 'backend\modules\user\models\forms\LoginEmailForm',
        ];
    }
