 ...
 * @property string $account_on_exchange
 *
...
class User extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['email', 'username', 'password', 'auth_key', 'access_token', 'logged_in_ip', 'created_ip', 'banned_reason', 'account_on_exchange'], 'string', 'max' => 255],
            [['email'], 'unique'],
            [['username'], 'unique'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'account_on_exchange' => 'Account On Exchange',
        ];
    }
